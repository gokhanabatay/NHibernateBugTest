...
namespace NHibernateBugTest.Session
{
    ...
    public class SqlBoolean : IEnhancedUserType
    {
        ...
        {
            object result = NHibernateUtil.Int16.NullSafeGet(rs, names[0], session, owner);
        ...
        {
            short? result = value != null ? Convert.ToInt16(value) : default(short?);
        ...
        /// </summary>
        public SqlType[] SqlTypes => new[] { new SqlType(DbType.Int16) };
